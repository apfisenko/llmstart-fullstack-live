...
- Документация: [`backend/.env.example`](../../../../../../../backend/.env.example), [`bot/.env.example`](../../../../../../../bot/.env.example), [`README.md`](../../../../../../../README.md) (порядок: backend → демо-SQL для SQLite → бот), [`docs/integrations.md`](../../../../../../integrations.md), [`docs/plan.md`](../../../../../../plan.md), [`.cursor/rules/conventions.mdc`](../../../../../../../.cursor/rules/conventions.mdc).
