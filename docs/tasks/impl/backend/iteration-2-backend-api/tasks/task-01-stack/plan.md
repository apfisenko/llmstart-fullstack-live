...
|---|----------|-----------------|
| 1 | Стек зафиксирован (этот документ + ADR-002) | Открыть `plan.md` задачи, [`docs/adr/adr-002-backend-stack.md`](../../../../../../adr/adr-002-backend-stack.md) |
| 2 | `conventions.mdc` содержит раздел backend без противоречий с разделом бот | Открыть [`.cursor/rules/conventions.mdc`](../../../../../../../.cursor/rules/conventions.mdc) |
| 3 | `vision.md` §9 совпадает с принятым стеком | Открыть [`docs/vision.md`](../../../../../../vision.md) §9 |
| 4 | `docs/adr/README.md` обновлён (ADR-002 в списке) | Открыть [`docs/adr/README.md`](../../../../../../adr/README.md) |
| 5 | Нет противоречий: ядро — backend, LLM только из backend, конфиг через `.env` | Сверить с [`docs/vision.md`](../../../../../../vision.md) |
